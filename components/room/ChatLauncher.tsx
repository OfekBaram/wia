...
export function ChatLauncher({ matchCount, unreadCount, onClick }: ChatLauncherProps) {
  return (
    ...
    >
      ...
      {unreadCount > 0 ? (
        <span className="absolute -top-1.5 -right-1.5 min-w-[20px] h-5 px-1 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center border-2 border-wia-bg animate-bounce">
